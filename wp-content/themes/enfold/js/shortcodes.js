(function($)
{
    ...
    $(document).ready(function()
    {
		...
		if($.fn.avia_masonry)
		$('.av-masonry-container').avia_masonry();
    });
...
$.fn.avia_masonry = function(options)
{
	...
	methods.open_masonry = function(e)
	{
		// e.preventDefault();
		
		var item 		= $(this).css({'z-Index':4}),
			container 	= item.parents('.av-masonry-container:eq(0)');
	...
	{	
		...
		container.on('click', 'a', methods.open_masonry);
